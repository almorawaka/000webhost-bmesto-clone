...
<?php
 ...
 $con = mysqli_connect("localhost","id19502634_root","tk9U%5_$2|2L1mz$","id19502634_bmes");
 ...
 // Creating an insert query using SQL syntax and storing it in a variable.
     $sql_insert = "INSERT INTO `spareparts`(`job_id`,`hospital_name`,`Hbook`,`stock_no`,`description`,`qty`,`submitby`)
         VALUES ('$j_id','$hospital_name','$h_name','$s_no','$s_dis','$qty','$submittedby')";
    ...
    <div class="card-header">
      ...
      <!-- from start -->
           <form method="POST" class="row g-3">
              <div class="col-md-6">
              <input type="text" name="job_id" placeholder=<?php $id=$_REQUEST['id']; echo $id ?> class="form-control" required>
            </div>

            <div class="col-md-6">
             <input type="text" class="form-control" placeholder="Hospital" name="hospital_name" required></p>
            </div>
