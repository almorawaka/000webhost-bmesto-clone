...
<tr><th><strong>Date</strong></th>
	...
	<th><strong>Update Status</strong></th>  </tr>
</thead>
<tbody>
...
<tr><td align="center"><?php echo $row["trn_date"]; ?></td>
	...
	<td align="center"> <a href="spare_parts.php?id=<?php echo $row["id"];?> Hospital : <?php echo $row["hospital_name"];?>   "> ADD </a> <a href ="view_spare_parts.php?id=<?php echo $row["id"];?>"> VIEW </a></td>
	<td align="center"><a href="edit.php?id=<?php echo $row["id"]; ?>"> Edit </a> <a href="delete.php?id=<?php echo $row["id"]; ?>"> Delete </a> </td> </td>
    <td align="center"><a href="https://bmesjobcard.000webhostapp.com/fpdf/index.php?id=<?php echo $row["id"]; ?>"> PRINT </a></td>
